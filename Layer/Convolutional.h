...
class Convolutional : public Layer{
    ...
    public:
        ...
        void backprop(const Matrix& prev_layer_data, const Matrix& next_layer_data){
            ...
            internal::ConvDims back_conv_dim(nobs, m_dim.out_channels, m_dim.channel_rows, m_dim.channel_cols, m_dim.conv_rows, m_dim.conv_cols);
            internal::convolve_valid(back_conv_dim, prev_layer_data.data(), false, m_dim.in_channels, dLz.data(), m_df_data.data());
